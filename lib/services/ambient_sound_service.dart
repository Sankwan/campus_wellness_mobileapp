...
//Will add sounds later to the assets folder and update the paths
  static const List<AmbientSoundOption> availableSounds = [
    ...
    AmbientSoundOption(
      ...
      name: 'Song1 ',
      description: '',
      assetPath: 'assets/sounds/Breathing.mp3',
      icon: '🎵',
    ),
    AmbientSoundOption(
      ...
      name: 'Song2',
      description: '',
      assetPath: 'assets/sounds/Deepfocus.mp3',
      icon: '🎵',
    ),
    AmbientSoundOption(
      ...
      name: 'Song3',
      description: '',
      assetPath: 'assets/sounds/Mindfullness.mp3',
      icon: '🎵',
    ),
    AmbientSoundOption(
      ...
      name: 'Song4',
      description: '',
      assetPath: 'assets/sounds/Sleep.mp3',
      icon: '🎵',
    ),
    AmbientSoundOption(
      ...
      name: 'Song5',
      description: '',
      assetPath: 'assets/sounds/Stress.mp3',
      icon: '🎵',
      isPremium: true,
    ),
    AmbientSoundOption(
      ...
      name: 'Song6',
      description: '',
      assetPath: 'assets/sounds/Song6.mp3',
      icon: '🎵',
    ),
    AmbientSoundOption(
      ...
      name: 'Song7',
      description: '',
      assetPath: 'assets/sounds/Song7.mp3',
      icon: '🎵',
    ),
  ];
